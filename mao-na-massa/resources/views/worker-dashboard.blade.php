                    ...
                    <table class="w-full mt-4 border-collapse border border-gray-300 dark:border-gray-700">
                        ...
                        <tbody>
                            @foreach ($solicitacoes as $solicitacao)
                                @if ($solicitacao->status === 'pendente')  <!-- Exibe apenas as pendentes -->
                                    <tr>
                                        ...
                                        <td class="border border-gray-300 dark:border-gray-700 px-4 py-2">
                                            ...
                                            <form action="{{ route('solicitacoes.atualizar', $solicitacao) }}" method="POST" class="inline-block">
                                                ...
                                                <button type="submit" class="btn btn-success bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded">
                                                    Aceitar
                                                </button>
                                            </form>
